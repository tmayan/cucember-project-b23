...
public class JobStepDef {
    ...
    public void you_are_prepared_for_a_job() {
        System.out.println("you are prepared for a job");
    }
    @Given("you apply in the market")
    public void you_apply_in_the_market() {
        System.out.println("you apply in the market");
    }
    @When("you apply for {int} jobs a day")
    public void you_apply_for_jobs_a_day(Integer int1) {
        System.out.println("you apply for {int} jobs a day");
    }
    @Then("you will eventually get the job")
    public void you_will_eventually_get_the_job() {
        System.out.println("you will eventually get the job");
    }
